...
public class DatePickerPopoverViewController: AbstractPickerPopoverViewController {
    ...
    fileprivate var popover: PopoverType! {
        return anyPopover as? PopoverType
    }
    ...
    override func refrectPopoverProperties() {
        ...
        if #available(iOS 13.4, *) {
            picker.preferredDatePickerStyle = popover.preferredDatePickerStyle as! UIDatePickerStyle
        }
