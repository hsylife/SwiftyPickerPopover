...
class DatePickerPopover: AbstractPopover {
    ...
    class func appearFrom(originView originView: UIView, baseViewController: UIViewController, title: String?, dateMode:UIDatePickerMode, initialDate:NSDate, doneAction: ((NSDate)->Void)?, cancelAction: (()->Void)?, clearAction: (()->Void)? = nil){
