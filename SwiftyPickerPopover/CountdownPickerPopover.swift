...
public class CountdownPickerPopover: AbstractPopover {
    ...
    public class func appearFrom(originView originView: UIView, baseView: UIView? = nil, baseViewController: UIViewController, title: String?, dateMode:UIDatePickerMode, initialInterval: NSTimeInterval, doneAction: ((NSTimeInterval)->Void)?, cancelAction: (()->Void)?, clearAction: (()->Void)? = nil){
