//
//  EquatablePickerPopover.swift
//  SwiftyPickerPopover
//
//  Created by Y.T. Hoshino on 2017/03/21.
...
public class EquatablePickerPopover: AbstractPopover, UIPickerViewDelegate, UIPickerViewDataSource {
    /// shared instance
    static let sharedInstance: EquatablePickerPopover = EquatablePickerPopover()
